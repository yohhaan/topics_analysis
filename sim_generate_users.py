...
def print_output_topics(nb_unique_domains, topics):
    ...
    t5 = sorted[4]
    print(
        "{}\t{}\t{}\t{}\t{}\t{}\n".format(nb_unique_domains, t1, t2, t3, t4, t5), end=""
    )
    ...
    if len(sys.argv) != 4:
        ...
        while nb_generated < nb_users:
            ...
            if len(topics) == 5:
                ...
                print_output_topics(nb_unique_domains, topics)
            else:
                ...
                for i in range(10):
                    if nb_generated >= nb_users:
                        ...
                        nb_generated += 1  # do not forget to increment
                        print_output_topics(nb_unique_domains, t)
